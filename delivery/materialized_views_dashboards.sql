...
CREATE MATERIALIZED VIEW VM_RANKING_PARTICIPANTES AS
SELECT
...
CREATE MATERIALIZED VIEW VM_TOP_PROJETOS_CERTIFICADOS AS
...
CREATE MATERIALIZED VIEW VM_CRESCIMENTO_MENSAL_PROJETOS AS
SELECT
...
CREATE MATERIALIZED VIEW VM_ATIVIDADES_ALTA_PARTICIPACAO AS
...
CREATE MATERIALIZED VIEW VM_PROJETOS_ACIMA_MEDIA_ALUNOS AS
...
CREATE MATERIALIZED VIEW VM_PARCEIROS_MULTIPLOS_PROJETOS AS
...
CREATE MATERIALIZED VIEW VM_TOTAL_ATIVIDADES_PROJETO AS
...
CREATE MATERIALIZED VIEW VM_CARGA_HORARIA_INSTRUTORES AS
...
CREATE MATERIALIZED VIEW VM_AVALIACAO_MEDIA_ATIVIDADE AS
...
CREATE MATERIALIZED VIEW VM_PARTICIPANTES_MAIS_ATIVOS AS
