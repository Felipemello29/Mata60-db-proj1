...
BEGIN
    IF (TG_OP = 'DELETE') THEN
        INSERT INTO TA_TB_ATIVIDADE (ID_ATIVIDADE, DS_TITULO_ATIVIDADE, TP_OPERACAO, NM_USUARIO_BD, NM_TERMINAL)
        VALUES (OLD.ID_ATIVIDADE, OLD.DS_TITULO_ATIVIDADE, 'D', current_user, inet_client_addr()::varchar);
        RETURN OLD;
    ELSIF (TG_OP = 'UPDATE') THEN
        INSERT INTO TA_TB_ATIVIDADE (ID_ATIVIDADE, DS_TITULO_ATIVIDADE, TP_OPERACAO, NM_USUARIO_BD, NM_TERMINAL)
        VALUES (NEW.ID_ATIVIDADE, NEW.DS_TITULO_ATIVIDADE, 'U', current_user, inet_client_addr()::varchar);
        RETURN NEW;
    ELSIF (TG_OP = 'INSERT') THEN
        INSERT INTO TA_TB_ATIVIDADE (ID_ATIVIDADE, DS_TITULO_ATIVIDADE, TP_OPERACAO, NM_USUARIO_BD, NM_TERMINAL)
        VALUES (NEW.ID_ATIVIDADE, NEW.DS_TITULO_ATIVIDADE, 'I', current_user, inet_client_addr()::varchar);
        RETURN NEW;
    END IF;
    RETURN NULL;
END;
...
BEGIN
    IF (TG_OP = 'DELETE') THEN
        INSERT INTO TA_RL_INSCRICAO_HISTORICO (ID_INSCRICAO, ST_PRESENCA, VL_NOTA_AVALIACAO, TP_OPERACAO, NM_USUARIO_BD, NM_TERMINAL)
        VALUES (OLD.ID_INSCRICAO, OLD.ST_PRESENCA, OLD.VL_NOTA_AVALIACAO, 'D', current_user, inet_client_addr()::varchar);
        RETURN OLD;
    ELSIF (TG_OP = 'UPDATE') THEN
        INSERT INTO TA_RL_INSCRICAO_HISTORICO (ID_INSCRICAO, ST_PRESENCA, VL_NOTA_AVALIACAO, TP_OPERACAO, NM_USUARIO_BD, NM_TERMINAL)
        VALUES (NEW.ID_INSCRICAO, NEW.ST_PRESENCA, NEW.VL_NOTA_AVALIACAO, 'U', current_user, inet_client_addr()::varchar);
        RETURN NEW;
    ELSIF (TG_OP = 'INSERT') THEN
        INSERT INTO TA_RL_INSCRICAO_HISTORICO (ID_INSCRICAO, ST_PRESENCA, VL_NOTA_AVALIACAO, TP_OPERACAO, NM_USUARIO_BD, NM_TERMINAL)
        VALUES (NEW.ID_INSCRICAO, NEW.ST_PRESENCA, NEW.VL_NOTA_AVALIACAO, 'I', current_user, inet_client_addr()::varchar);
        RETURN NEW;
    END IF;
    RETURN NULL;
END;
