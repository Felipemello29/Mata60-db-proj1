...
BEGIN
    FOR run IN 1..20 LOOP
        ...
        FOR r IN
            ...
            JOIN TB_ATIVIDADE a ON alloc.ID_ATIVIDADE = a.ID_ATIVIDADE
            WHERE NOT EXISTS (
                SELECT 1 FROM tabela_projeto_extensao proj
...
CREATE INDEX IDX_PROJETO_COORDENADOR ON tabela_projeto_extensao(ID_INSTR_COORDENADOR);
...
-- Ãndices redundantes removidos (ID_INSCRICAO jÃ¡ possui Ã­ndice automÃ¡tico pela constraint UNIQUE)
...
-- Ãndices redundantes removidos (DS_EMAIL_CONTATO jÃ¡ possui Ã­ndice automÃ¡tico pela constraint UNIQUE)
-- CREATE INDEX IDX_PARTICIPANTE_EMAIL ON tabela_participante(DS_EMAIL_CONTATO);
